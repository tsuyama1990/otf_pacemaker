...
class SeedGenerator:
    ...
    def run(self):
        ...
        for i, atoms in enumerate(selected_structures):
            # We can optionally parallelize this too, but for now stick to serial or reuse Orchestrator logic?
            # User requirement was parallelizing Phase 2. Phase 1 parallelization wasn't explicitly requested but beneficial.
            # Keeping it serial for simplicity unless requested.
